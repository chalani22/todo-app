...
export default function SignInPage() {
  ...
  // Basic client-side validation (prevents empty submits)
      ...
      <div className="flex min-h-screen w-full flex-col lg:flex-row overflow-hidden">
          ...
          <div className="max-w-md space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl xl:text-5xl font-extrabold leading-tight tracking-tight">
                Secure task management with precision access control.
              </h1>
              <p className="text-lg opacity-90">
                Sign in to manage todos with role-aware permissions (User / Manager / Admin).
              </p>
            </div>
          </div>
        ...
        <div className="lg:hidden w-full bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-500 text-white px-6 py-5">
          ...
          <div className="mt-4 max-w-md">
            ...
            <p className="mt-1 text-sm opacity-90">Role-aware access for safer todo management.</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    {/* Placeholder (no reset flow in this app) */}
                    <span className="text-sm font-semibold text-blue-600 dark:text-blue-400 opacity-70">
                      Forgot password?
                    </span>
                  </div>
                </div>
                ...
                {/* Error */}
                {signIn.isError && <p className="text-sm text-red-600">{String(signIn.error.message)}</p>}
              </form>
